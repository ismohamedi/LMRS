...
$sex=$_POST['sex'];;
if ($connect) {
$link="INSERT INTO register_members (fullname,faculty,regnumber,phonenumber,email,sex,regdate) VALUES('$fullname','$Faculty','$regnumber','$phonenumber','$email','$sex',now())
";

	$output=mysqli_query($connect,$link);
	if ($output) {
	echo "you have successfully register student ".$fullname."";
	}
else{
...
?>
	...
	<h1 align="center" style=" margin-top:2%">Register Student</h1><br>
<form method="POST">
       ...
       <label>Faculty:</label><input type="text" name="faculty" required=""><br><br>
	    <label>Reg-Number:</label><input type="string" name="regnumber" required=""><br><br>
